      ...
      <div className={`${styles['featured-products-content']} container`}>
        ...
        <div className={styles['featured-products-subtitle']}>
          ...
          <div className={styles['featured-products_subtitle-subtitle']}>
            <span>Lorem ipsum dolor, sit amet consectetur adipisicing elit. <br />Soluta, vitae a. Enim impedit error provident.</span>
          </div>
          <div className={styles['featured-products_subtitle-controller']}>
